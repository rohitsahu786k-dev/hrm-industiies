...
export const fallbackProducts: Product[] = [
  ...
  {
    id: 107,
    title: "Tin Shades & Metal Roofing",
    slug: "tin-shades-roofing",
    excerpt: "Durable, custom-fabricated metal tin shades for homes, terraces, vehicle parking, and commercial spaces.",
    content: "Engineered tin shade structures and industrial metal roofing built with heavy tubular framing, zinc coating, and monsoon-resistant flashing.",
    short_tagline: "Heavy-Duty Metal Shades & Terrace Roofing",
    product_code: "HRM-TS-07",
    material_info: "Galvanized Iron (GI), Polycarbonate, Color Coated Sheets",
    finish_info: "Anti-Corrosive Zinc Primer & Polyurethane Coat",
    applications: "Residential Terraces, Parking Bays, Commercial Courtyards",
    key_features: "Wind load resistance, leak-proof fixing, durable frame anchoring.",
    technical_notes: "Rafter spacing and sheet thickness calculated for maximum storm water run-off and structural safety.",
    hero_desktop_image: "/photos/craftsmanship.png",
    hero_mobile_image: "/photos/craftsmanship.png",
    gallery_images: ["/photos/craftsmanship.png"],
    show_on_home: true,
    home_sort_order: 7,
    cta_text: "Get Shade Quote",
    cta_url: "/contact",
    category_slugs: ["sheds-canopies"]
  },
  {
    id: 108,
    title: "Luxury Metal Furniture",
    slug: "luxury-metal-furniture",
    excerpt: "Premium custom furniture, dining tables, seating frames, and statement pieces with refined metal detailing.",
    content: "Bespoke metal furniture crafted from brass accents, polished stainless steel, and matte powder-coated steel for luxury interiors.",
    short_tagline: "Bespoke Tables, Seating & Designer Metal Frames",
    product_code: "HRM-MF-08",
    material_info: "SS 304, Solid Brass Accents, Heavy MS Hollow Sections",
    finish_info: "PVD Gold, Brushed Satin, Velvet Matte Black",
    applications: "Luxury Villas, Boutique Hotels, High-End Dining & Lounges",
    key_features: "Concealed joinery, hand-finished surfaces, custom dimensions.",
    technical_notes: "Precision MIG/TIG welding with invisible joint grinding.",
    hero_desktop_image: "/photos/project-2.png",
    hero_mobile_image: "/photos/project-2.png",
    gallery_images: ["/photos/project-2.png"],
    show_on_home: true,
    home_sort_order: 8,
    cta_text: "Discuss Furniture",
    cta_url: "/contact",
    category_slugs: ["metal-furniture"]
  },
  {
    id: 109,
    title: "Luxury Custom Metal Items",
    slug: "luxury-custom-items",
    excerpt: "Unique metal décor, laser-cut space dividers, wall art features, and bespoke architectural creations.",
    content: "One-of-one custom metal artwork, decorative partitions, and architectural installations made to order for statement spaces.",
    short_tagline: "Statement Metal Décor, Partitions & One-of-One Items",
    product_code: "HRM-LX-09",
    material_info: "Laser-cut MS, SS 304, Copper & Brass Inlays",
    finish_info: "Custom Metallic Textures, Patina & PU Finishes",
    applications: "Resort Lobbies, Villa Entrances, Luxury Interiors",
    key_features: "Custom pattern cutting, seamless mounting, premium feel.",
    technical_notes: "Designed in 3D CAD before laser processing.",
    hero_desktop_image: "/photos/project-3.png",
    hero_mobile_image: "/photos/project-3.png",
    gallery_images: ["/photos/project-3.png"],
    show_on_home: true,
    home_sort_order: 9,
    cta_text: "Create Bespoke Piece",
    cta_url: "/contact",
    category_slugs: ["metal-furniture"]
  }
  }
